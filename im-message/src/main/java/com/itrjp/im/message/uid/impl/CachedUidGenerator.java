 ...
 */
package com.itrjp.im.message.uid.impl;

import com.itrjp.im.message.uid.buffer.BufferPaddingExecutor;
import com.itrjp.im.message.uid.buffer.RejectedPutBufferHandler;
import com.itrjp.im.message.uid.buffer.RejectedTakeBufferHandler;
import com.itrjp.im.message.uid.buffer.RingBuffer;
import com.itrjp.im.message.uid.exception.UidGenerateException;
